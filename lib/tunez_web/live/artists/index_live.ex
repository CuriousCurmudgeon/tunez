defmodule TunezWeb.Artists.IndexLive do
  ...
  def handle_params(params, _url, socket) do
    ...
    page_params = AshPhoenix.LiveView.params_to_page_opts(params)
  ...
  def handle_event("search", %{"query" => query, "sort_by" => sort_by}, socket) do
    params = remove_empty(%{q: query, sort_by: sort_by})
    {:noreply, push_patch(socket, to: ~p"/?#{params}")}
  end
